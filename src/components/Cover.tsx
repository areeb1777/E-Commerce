  ...
  return (
    <div className="w-full h-auto relative py-10 md:py-20">
      ...
      <div className="hidden md:block">
        <div className="absolute left-[314px] top-[146px] text-center text-[80px] font-bold leading-[80px] theme-dependent-text">
          ecommerce
          <br />
          user interface kit
        </div>
        ...
        <div className="absolute left-[570px] top-[800px]">
          <Link href="/home">
