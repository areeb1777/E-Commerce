  ...
  return (
    <div className="w-full h-auto relative py-10 md:py-20">
      ...
      <div className="hidden md:block">
        <div className="absolute left-[314px] top-[146px] text-center text-white text-[80px] font-bold leading-[80px] font-['Arial']">
          ecommerce
          <br />
          user interface kit
        </div>
        <div className="absolute left-[557px] top-[78px] text-[#8f93ff] text-[51.70px] font-normal leading-[51.70px] font-['Dancing Script']">
          JUST UX
        </div>
        <div className="absolute left-[42px] top-[386px] flex flex-col justify-start items-start gap-6">
          ...
          <div className="flex flex-col justify-start items-start gap-[5.49px]">
            <div className="text-white text-xl font-normal leading-7 font-['Arial']">The Dandy chair</div>
            <div className="text-white text-lg font-normal leading-[27px] font-['Arial']">£250</div>
          </div>
        </div>
        <div className="absolute left-[289.27px] top-[441px] flex flex-col justify-start items-start gap-6">
          ...
          <div className="flex flex-col justify-start items-start gap-[5.49px]">
            <div className="text-white text-xl font-normal leading-7 font-['Arial']">New Lamp</div>
            <div className="text-white text-lg font-normal leading-[27px] font-['Arial']">£250</div>
          </div>
        </div>
        <div className="absolute left-[536.55px] top-[367px] flex flex-col justify-center items-center gap-6">
          ...
          <div className="flex flex-col justify-start items-start gap-[5.49px]">
            <div className="text-white text-xl font-normal leading-7 font-['Arial']">The Stanley Table</div>
            <div className="text-white text-lg font-normal leading-[27px] font-['Arial']">£125</div>
          </div>
        </div>
        ...
        <div className="absolute left-[1032.27px] top-[360px] flex flex-col justify-center items-center gap-6">
          ...
          <div className="flex flex-col justify-start items-start gap-[5.49px]">
            <div className="text-white text-xl font-normal leading-7 font-['Arial']">Andel Vase</div>
            <div className="text-white text-lg font-normal leading-[27px] font-['Arial']">£95</div>
          </div>
        </div>
      ...
      <div className="md:hidden">
        <div className="text-center text-white text-[30px] font-bold leading-tight font-['Arial'] mb-4">
          ecommerce
          <br />
          user interface kit
        </div>
        <div className="text-center text-[#8f93ff] text-[20px] font-normal leading-tight font-['Dancing Script'] mb-4">
          just ux
        </div>
