      ...
      <div className="hidden md:flex flex-col md:flex-row md:justify-between md:items-start gap-8 md:gap-6">
        <div className="flex flex-col items-start gap-4 md:w-1/4">
          ...
          <div className="flex flex-col gap-2">
            <div className="text-[#2a254b] text-xl font-normal leading-7">
              Next day as standard
            </div>
            <div className="text-[#2a254b] text-base font-normal leading-normal">
      ...
      <div className="md:hidden flex flex-col items-center gap-9 p-6">
        <div className="w-[385px] h-auto bg-white flex flex-col justify-center items-start gap-9">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <div className="text-[#2a254b] text-base font-normal leading-snug">
                Next day as standard
              </div>
              <div className="text-[#2a254b] text-sm font-normal leading-[21px]">
                Order before 3pm and get your order the next day as standard
              </div>
            </div>
          </div>
